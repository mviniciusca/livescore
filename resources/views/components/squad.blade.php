...
<div class="flex gap-2 border border-slate-200 dark:border-black p-2 my-2 items-center opacity-90 hover:opacity-100 transition-all duration-100
@if ($score < $maxPoint) bg-slate-100 dark:bg-zinc-800 @endif
@if($score == $maxPoint) bg-indigo-100 dark:bg-zinc-600 dark:text-white @endif
">
